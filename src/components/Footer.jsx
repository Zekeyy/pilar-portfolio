...
const Footer = ({ isDarkMode }) => {
  ...
  // SVG Icons with consistent sizing and transparent backgrounds
  const socialIcons = {
    github: (
    ...
    <footer id="footer" className={`${footerBgClasses} py-12 px-5`}>
      <div className="max-w-2xl mx-auto text-center space-y-6">
        ...
        <div className="flex justify-center space-x-6 pt-6">
          {[
            { icon: 'github', link: 'https://github.com/Zekeyy', label: 'GitHub' },
            { icon: 'facebook', link: 'https://www.facebook.com/ezekiel.pilar.1/', label: 'Facebook' },
            { icon: 'linkedin', link: 'https://www.linkedin.com/in/ezekiel-pilar-6880062ba/', label: 'LinkedIn' },
          ].map((social, index) => (
            <a
              key={index}
              href={social.link}
              ...
              } hover:bg-blue-700 hover:text-white hover:border-blue-700 hover:scale-110 transition-all duration-300`}
